...
public class ActivitySeatBooking extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String PATH_JOURNEYS_AGENCIES = "PATH_JOURNEYS_AGENCIES";
    ...
    private void initializeViews() {
        ...
        Button m_btn_confirm = findViewById(R.id.btn_confirm_row);
        m_btn_confirm.setOnClickListener(this);

        Button m_btn_cancelSeat = findViewById(R.id.btn_cancel_row);
