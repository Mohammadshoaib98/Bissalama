...
public class ActivityAddCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_btn_code = findViewById(R.id.btn_code);
        ...
        m_btn_code.setOnClickListener(v -> {
            ...
            Toast.makeText(ActivityAddCode.this, "Add Code Successfully", Toast.LENGTH_SHORT).show();
